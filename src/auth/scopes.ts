...
export async function initialiseScopes() {
    ...
    if (hasLessThan256(CUSTOM_SCOPES))
        throw new Error("Custom scopes contained values that were less than 512! Please fix your configuration");

    if (hasNonPowers(CUSTOM_SCOPES))
        throw new Error("Custom scopes contained values that were not powers of 2! Please fix your configuration");
